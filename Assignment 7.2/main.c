...
{
	/* add your code here */
	//compare the size and see which one larger
	// if the first one size is smaller than second
	//the number of times added will be equivalent to the top
	// second line will remove the head;
	// if the first one smalelr than second
	// number of times added will be limited by second
	// remove the head(0)
	int i, count = 1;
	ListNode *cur, *pre;
	cur = (ll1 -> head);
